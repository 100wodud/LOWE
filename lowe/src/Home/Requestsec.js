    ...
    return (
      <section className="Mainpage_Request_section">
        ...
        <div>
            ...
            <div style={{fontFamily:"Noto Sans", fontSize: "46px", fontWeight: "normal", marginBottom:"36px"}}>로위에 <strong>입점 문의 신청</strong>해보세요</div>
        ...
        <div>
            ...
            <div style={{fontFamily:"Noto Sans", fontSize: "5.33333vw", marginBottom:"3.4666vw"}}><span style={{fontWeight: "bold"}}>입점 문의</span></div>
