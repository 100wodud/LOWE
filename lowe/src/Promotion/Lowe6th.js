                ...
                <div className="Lowe5th_div" >
                    ...
                    <div className="Lowe6th_firstsec_div">
                        ...
                        <div style={{marginTop: "40px"}}>
                            <div className="Lowe6th_firstsec_sub">로위 L7홍대점은</div>
                            <div className="Lowe6th_firstsec_sub"><span>공유미용실 시스템(입점형)이 아닌</span></div>
                            <div className="Lowe6th_firstsec_sub">일반미용실 시스템(채용형)과 동일<span>합니다</span></div>
                        </div>
                        <div style={{marginTop: "115px"}}>
                            ...
                            <div style={{marginBottom: "40px", maxWidth: "351px", wordBreak: "keep-all"}}>
